...
window.ISLANDS = [
  // --- 第 1 行：左偏 + 右偏 ---
  {
    ...
    emoji: "🗺️",
    color: "#F9A825",
    sprite: "assets/islands/growth.png",
    x: 28, y: 160, size: 264,
  ...
  },
  {
    ...
    emoji: "🌳",
    color: "#66BB6A",
    sprite: "assets/islands/experience.png",
    x: 72, y: 165, size: 288,
  ...
  // --- 第 2 行：居中偏左 + 右偏 ---
  {
    ...
    emoji: "🎈",
    color: "#4FC3F7",
    sprite: "assets/islands/travel.png",
    x: 20, y: 430, size: 253,
  ...
  },
  {
    ...
    emoji: "📖",
    color: "#AB47BC",
    sprite: "assets/islands/literature.png",
    x: 55, y: 470, size: 253,
  ...
  // --- 第 3 行：居中大岛 + 右侧小岛 ---
  {
    ...
    emoji: "🎵",
    color: "#EC407A",
    sprite: "assets/islands/music.png",
    x: 35, y: 750, size: 275,
  ...
  },
  {
    ...
    emoji: "🎬",
    color: "#FF7043",
    sprite: "assets/islands/film.png",
    x: 78, y: 790, size: 264,
  ...
  // --- 第 4 行：足球大锚 + 美食 ---
  {
    ...
    emoji: "⚽",
    color: "#26A69A",
    sprite: "assets/islands/football-etihad.png",
  ...
  },
  {
    ...
    emoji: "🍽️",
    color: "#FFCA28",
    sprite: "assets/islands/food.png",
